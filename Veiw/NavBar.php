                ...
                <div id="NavBar" class="collapse navbar-collapse" style="margin-right: 60px">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        else 
                        {
                            ...
                            echo '<li><a href="" data-toggle="modal" data-target="#signupModal"><span class="glyphicon glyphicon-user test" ></span> SignUp</a></li>';
                        }
                        ?>
                            ...
                            <form action="../Controllers/loginUserController.php" method="POST">
                                <div class="row_">
                                    ...
                                    <div class="col_">
                                        ...
                                        <a href="" class="google btn_"   data-toggle="modal" data-target="#signupModal" style="background-color:#6cc16c"><i class="fa fa-google fa-fw">
                                            </i> Sign Up
                                        </a>
                                    </div>
                    ...
                    <div class="modal-body">
                        <form action="../Controllers/signupUserController.php" class="well" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input  type="text" class="form-control" id="fn" placeholder="Enter first name" name="first_name" minlength="2" maxlength="100" required>
                            </div>
                            <div class="form-group">
                                <label>Last Name:</label>
                                <input  type="text" class="form-control" id="ln" placeholder="Enter last name" name="last_name" minlength="2" maxlength="100"  required>
                            </div>
                            <div class="form-group">
                                <label>Email:</label>
                                <input type="email" class="form-control" id="email" placeholder="Enter email" name="email" minlength="2" required>
                            </div>
                            <div class="form-group">
                                <label for="pwd">Password:</label>
                                <input type="password" id="pwd" class="form-control" placeholder="Enter password" name="password" minlength="10" maxlength="100" required>
                            </div>
                            <div class="form-group">
                                <label >Repeat Password:</label>
                                <input type="password" id="rpwd" class="form-control" id="re_pwd" placeholder="Enter password again" name="resetpassword" minlength="10" maxlength="100"  required>
