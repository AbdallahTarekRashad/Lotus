...
<div class="container-fluid ">
        ...
        <div class="col-sm-9">   
                    ...
                    for($j = $i*3 ; $j < $i+3 && $j < $numOfProduct; $j++)
                    {
                        ...
                        <div class="panel panel-primary text-center">
                            ...
                            <div class="panel-body product_img">
                                <img src="../Resources/ProductImages/'.$productData[$j]['image'].'" class="img-responsive" style="" alt="Image"></div>
                    ...
                    for($j = $i*3 ; $j < $i+3 && $j < $numOfProduct; $j++)
                    {
                        ...
                        echo'<div class="col-sm-4">
                                <div class="panel panel-success text-center">
                                    <div class="panel-heading">'.$productData[$j]['name_en'].'</div>
                                    <div class="panel-body product_img"><img src="../Resources/ProductImages/'.$productData[$j]['image'].'" style="width:100%" alt="Image"></div>
                                    <div class="panel-footer">
            ...
            <div class="pages_number text-center">
                <ul class="pagination">
                    ...
                    $nextPage = (int) $page + 1;
                    if ($page > 1) {
                        echo'<li class="previous "><a href="Products.php?c='.$categoryId.'&page=' . $previousPage . '">Previous</a></li>';
                    }
                    ...
                    if ($page < $ProductPage) {
                        echo'<li class="next"><a href="Products.php?c='.$categoryId.'page=' . $nextPage . '">next</a></li>';
                    }
                    ?>
                </ul>
            </div>
    ...
    if(isset($_SESSION['id']))
    {
        foreach($productData as $value )
        {
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action=" " class="well" method="POST">
                                    ...
                                    <div class="form-group">
                                        <span style="color: green">Price For One : </span><span id="price">'.$value['price'].' </span> EGP<br>
                                    </div>
                                    <div class="form-group">
            ...
            echo'<script src="../Resources/JS/products.js"></script>';
        }
    }
    ?>
